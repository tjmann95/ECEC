...
class TicTacToeGame:
    ...
    def __init__(self, master):
        ...
        self.canvas_for_board = Canvas(self.frame, width=400, height=400, background='blue', highlightthickness=0, bd=0)
    ...
    def start_for_2players_no_computer(self):
        ...
        self.TTT = [ ['_', '_', '_', '_'],  ['_', '_', '_', '_'], ['_', '_', '_', '_'], ['_', '_', '_', '_'] ]
    ...
    def draw_board(self):
        ...
        self.canvas_for_board.create_rectangle(0, 0, 400, 400,  outline='blue', width=6)
    ...
    def check_for_winning_combos(self):
        ...
        print b
        r1 = self.TTT[0][0] + self.TTT[0][1] + self.TTT[0][2] + self.TTT[0][3]
        r2 = self.TTT[1][0] + self.TTT[1][1] + self.TTT[1][2] + self.TTT[1][3]
        r3 = self.TTT[2][0] + self.TTT[2][1] + self.TTT[2][2] + self.TTT[2][3]
        r4 = self.TTT[3][0] + self.TTT[3][1] + self.TTT[3][3] + self.TTT[3][3]
        c1 = self.TTT[0][0] + self.TTT[1][0] + self.TTT[2][0] + self.TTT[3][0]
        c2 = self.TTT[0][1] + self.TTT[1][1] + self.TTT[2][1] + self.TTT[3][1]
        c3 = self.TTT[0][2] + self.TTT[1][2] + self.TTT[2][2] + self.TTT[3][2]
        c4 = self.TTT[0][3] + self.TTT[1][3] + self.TTT[2][3] + self.TTT[3][3]
        d1 = self.TTT[0][0] + self.TTT[1][1] + self.TTT[2][2] + self.TTT[3][3]
        d2 = self.TTT[3][0] + self.TTT[2][1] + self.TTT[1][2] + self.TTT[0][3]
        ...
        if 'XXXX' in wins:
            ...
            self.end()
        elif self.turn_number == len(self.TTT) * len(self.TTT[0]) + 1:
